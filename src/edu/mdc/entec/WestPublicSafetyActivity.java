...
public class WestPublicSafetyActivity extends Activity {
    ...
    String[] publicSafety={"Call West Campus Public Safety", 
    		"Public Safety Site",
    };
   ...
   private OnItemClickListener mListViewClicks = new OnItemClickListener() {
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			long arg3) {
	        		...
	        		switch(arg2){
	case 0:
		startActivity(new Intent(Intent.ACTION_DIAL, Uri.parse("tel:305-237-8100")));
		break;
	case 1:
