      ...
      //btnMyMDC
        ...
        MyMdc.setOnClickListener(new OnClickListener() {
        	...
        	public void onClick(View v) {
				...
				EasyTracker.getTracker().sendEvent("ui_action", "north_activity", "mymdc_button", null);
			}
        });
      ...
      //btnEmail
        ...
        Email.setOnClickListener(new OnClickListener() {
        	...
        	public void onClick(View v) {
				...
				//Google Analytics Event Tracker
				EasyTracker.getTracker().sendEvent("ui_action", "north_activity", "email_button", null);
			}
        });
      ...
      //bnEvents
        ...
        Events.setOnClickListener(new OnClickListener() {
        	...
        	public void onClick(View v) {
				...
				//Google Analytics Event Tracker
				EasyTracker.getTracker().sendEvent("ui_action", "north_activity", "events_button", null);
			}
        });
      ...
      //btnAngel
        ...
        Angel.setOnClickListener(new OnClickListener() {
        	...
        	public void onClick(View v) {
				...
				//Google Analytics Event Tracker
				EasyTracker.getTracker().sendEvent("ui_action", "north_activity", "angel_button", null);
			}
        });
      ...
      //btnNews
        ...
        News.setOnClickListener(new OnClickListener() {
        	...
        	public void onClick(View v) {
				...
				//Google Analytics Event Tracker
				EasyTracker.getTracker().sendEvent("ui_action", "north_activity", "news_button", null);
			}
        });
      ...
      //btnLibrary
        ...
        Library.setOnClickListener(new OnClickListener() {
        	...
        	public void onClick(View v) {
				...
				//Google Analytics Event Tracker
				EasyTracker.getTracker().sendEvent("ui_action", "north_activity", "library_button", null);
			}
        });
      ...
      //btnCourses
        ...
        Courses.setOnClickListener(new OnClickListener() {
        	...
        	public void onClick(View v) {
				...
				//Google Analytics Event Tracker
				EasyTracker.getTracker().sendEvent("ui_action", "north_activity", "courses_button", null);
			}
        });
      ...
      //btnPublicSafety
        ...
        PublicSafety.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				//Google Analytics Event Tracker
				EasyTracker.getTracker().sendEvent("ui_action", "north_activity", "safety_button", null);
			}
        });
      ...
      //btnPhoneDirectory
        ...
        PhoneDir.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				//Google Analytics Event Tracker
				EasyTracker.getTracker().sendEvent("ui_action", "north_activity", "directory_button", null);
			}
        });
        ...
        SwitchCampus.setOnClickListener(new OnClickListener(){
        	...
        	public void onClick(View v) {
				...
				//Google Analytics Event Tracker
				EasyTracker.getTracker().sendEvent("ui_action", "north_activity", "home_button", null);
        		finish();
        	}
        });
